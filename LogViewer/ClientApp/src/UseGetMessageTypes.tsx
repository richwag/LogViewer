...
function useGetMessageTypes(environment: string | null): [Array<MessageType>, boolean, string | null] {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`${config.server_prefix_url}ErrorManagement/MessageTypes?environment=${environment}`, {
          mode: "cors",
          credentials: "include",
        });
